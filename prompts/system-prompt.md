...
When you need to look up real-time information (current docs, APIs, error messages, latest versions, etc.), use the "web-search" MCP tool instead of WebFetch or WebSearch.
